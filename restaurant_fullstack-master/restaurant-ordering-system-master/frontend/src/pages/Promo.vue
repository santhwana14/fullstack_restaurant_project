    ...
    <div class="promotions">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="activity-time">Discount 20% Manchurian & Dessert </div>
                            </td>
                            <td class="bg-light-gray">
        ...
        <div class="promotions-item">
            <div class="content-box">
                <img src="../assets/images/dosa/dosa-1.png" alt="">
            </div>

            <div class="description">
                <h3>party dosa upto 50% off</h3>
                <ul>
                    <li>
                        <p>Order more than 10 dosas will get discount 50%</p>
                    </li>
                    <li>

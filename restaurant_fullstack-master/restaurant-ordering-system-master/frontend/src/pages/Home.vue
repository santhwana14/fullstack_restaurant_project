    ...
    <div>
        <div class="home-main">
            ...
            <div class="image">
                ...
                <!-- <img src="../assets/images/d.png" alt="" class="home-parallax-img"> -->
        ...
        <div class="home-category">
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/side/sides.png" alt="">
                <h3>sides</h3>
            </router-link>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p>Food to customers is always guaranteed of the best quality. Our dishes are made by expert chef
                    , promising to bring explosive, delicate, impressive flavors. Our delivery
